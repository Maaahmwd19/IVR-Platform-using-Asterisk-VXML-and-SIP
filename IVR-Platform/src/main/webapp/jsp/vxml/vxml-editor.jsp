    ...
    <form>
        <block>
            ...
            function saveToServer() {
                ...
                // Construct formatted file name with .vxml
                const formattedFileName = fileNameInput.endsWith('.vxml') ? fileNameInput : fileNameInput + '.vxml';
                console.log('formattedFileName:', formattedFileName); // Debug: Log formatted file name

                // Validate formatted file name
                if (formattedFileName === '.vxml' || !formattedFileName.endsWith('.vxml')) {
                    showValidationPopup(false, 'Save Error', 'Invalid file name format');
                    console.error('Validation failed: Invalid formatted file name:', formattedFileName);
                    return;
                }
                ...
                // Validate filePath
                if (filePath === '/var/lib/asterisk/vxml/' || !filePath.endsWith('.vxml')) {
                    showValidationPopup(false, 'Save Error', 'Invalid file path format');
                    console.error('Validation failed: Invalid file path:', filePath);
                    return;
                }
