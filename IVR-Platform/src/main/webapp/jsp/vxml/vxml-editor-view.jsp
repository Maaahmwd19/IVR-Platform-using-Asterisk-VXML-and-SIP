                        ...
                        <div class="mb-4">
                            <div class="flex items-center gap-4">
                                ...
                                <div class="w-48">
                                    ...
                                    <button disabled class="flex w-full items-center justify-center gap-2 rounded-md border border-gray-300 bg-gray-100 px-3 py-2 text-sm font-semibold text-gray-400 cursor-not-allowed">
...
showCopiedToast(name);
            ...
            // Hide save and edit buttons in read-only mode
            ...
            if (addVxmlBtn) addVxmlBtn.style.display = 'none';
